...
const AdminDashboard = () => {
  ...
  if (loading) {
    return (
      <Box sx={{ minHeight: '100vh', display: 'flex', justifyContent: 'center', alignItems: 'center', background: '#0a0a0a' }}>
        <CircularProgress size={48} thickness={3} sx={{ color: '#FF6B35' }} />
      </Box>
    );
  }
    ...
    <Box sx={{ 
      ...
      <Box sx={{
        ...
        <Box sx={{ 
          ...
          borderRadius: '50%', background: 'radial-gradient(circle, rgba(255,107,53,0.1) 0%, rgba(0,0,0,0) 70%)',
        ...
        <Container maxWidth="lg" sx={{ position: 'relative', zIndex: 1 }}>
          <Box sx={{ display: 'flex', alignItems: 'center', gap: 3 }}>
            <Box sx={{ 
              p: 2, background: 'rgba(255,107,53,0.1)', borderRadius: '20px', 
              border: '1px solid rgba(255,107,53,0.3)', backdropFilter: 'blur(10px)',
            ...
            <Box>
              ...
              <Typography variant="subtitle1" sx={{ color: '#FFCDB8', fontSize: '1.1rem', mt: 0.5, letterSpacing: '0.5px' }}>
      ...
      <Container maxWidth="lg">
        ...
        <Grid container spacing={4} sx={{ mb: 8 }}>
          <Grid item xs={12} md={6}>
            <Card sx={{
              ...
              <Box sx={{ position: 'absolute', top: 0, left: 0, width: '4px', height: '100%', background: '#FF6B35', boxShadow: '0 0 10px #FF6B35' }} />
              <CardContent sx={{ p: 4, display: 'flex', alignItems: 'center', justifyContent: 'space-between' }}>
                ...
                <SecurityUpdateWarning sx={{ fontSize: 80, color: 'rgba(255, 107, 53, 0.2)' }} />
              </CardContent>
            </Card>
          </Grid>
        ...
        <Paper sx={{
          ...
          <Tabs value={tabValue} onChange={handleTabChange} sx={{
            ...
            px: 3, pt: 3,
            '& .MuiTabs-indicator': { height: 3, borderRadius: '3px 3px 0 0', background: '#FF6B35', boxShadow: '0 0 10px #FF6B35' },
                ...
                {pendingTours.map((tour) => (
                  <Grid item xs={12} md={6} key={tour.id}>
                    <Card sx={{
                      ...
                      '&:hover': { transform: 'translateY(-5px)', borderColor: 'rgba(255, 107, 53, 0.3)', boxShadow: '0 10px 30px rgba(14, 165, 233, 0.15)' }
                    }}>
                      <CardContent sx={{ flexGrow: 1, p: 4 }}>
                        <Box sx={{ display: 'flex', alignItems: 'center', mb: 3 }}>
                          <Box sx={{ p: 1.5, background: 'rgba(56,189,248,0.1)', borderRadius: '12px', mr: 2 }}>
                            <Tour sx={{ color: '#FF6B35' }} />
                          </Box>
